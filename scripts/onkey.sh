...
install() {
    ...
    wget --inet4-only https://raw.githubusercontent.com/vinerproxy/vMinerProxy/master/release/vtProxy -O /root/vinerProxy/vinerProxy
...
install100() {
    ...
    wget --inet4-only https://raw.githubusercontent.com/vinerproxy/vMinerProxy/master/release/vtProxy100 -O /root/vinerProxy/vinerProxy
